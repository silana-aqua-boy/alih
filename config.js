...
module.exports = {
    ...
    URL_1NAME: process.env.URL_1NAME === undefined ? '🎃DXN(علي،الواقدي)🎃' : process.env.URL_1NAME,
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/noureddine_ouafy' : process.env.URL_1LINK,
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨قناتي،اليواتيوب✨' : process.env.URL_2NAME,
    ...
    CAPTION: process.env.CAPTION === undefined ? '🐶DXN(علي،الواقدي)🐕' : process.env.CAPTION,
